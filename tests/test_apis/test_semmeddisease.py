...
class TestSingleHopQuery(unittest.TestCase):
    ...
    def test_disease2bp(self):
        ...
        seqd = SingleEdgeQueryDispatcher(output_cls='BiologicalProcess',
                                         ...
                                         values='C0027430')
        seqd.query()
        self.assertTrue("Smell Perception".upper() in seqd.G)
        edges = seqd.G['UMLS:C0027430']["Smell Perception".upper()]
        self.assertTrue('SEMMED Disease API' in get_apis(edges))
    ...
    def test_disease2cc(self):
        ...
        seqd = SingleEdgeQueryDispatcher(output_cls='CellularComponent',
                                         ...
                                         values="C0431506")
        seqd.query()
        self.assertTrue("22Q11.2" in seqd.G)
        edges = seqd.G['UMLS:C0431506']["22Q11.2"]
        self.assertTrue('SEMMED Disease API' in get_apis(edges))
