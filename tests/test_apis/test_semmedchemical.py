...
class TestSingleHopQuery(unittest.TestCase):
    def test_chemical2chemicalsubstance(self):
        ...
        seqd.query()
        self.assertTrue("C0043047" in seqd.G)
        edges = seqd.G["UMLS:C0043716"]["C0043047"]
    ...
    def test_chemical2bp(self):
        ...
        seqd.query()
        self.assertTrue("C0024262" in seqd.G)
        edges = seqd.G["UMLS:C0043716"]["C0024262"]
        self.assertTrue("SEMMED Chemical API" in get_apis(edges))
    ...
    def test_chemical2cc(self):
        ...
        seqd.query()
        self.assertTrue("C0230839" in seqd.G)
        edges = seqd.G["UMLS:C1122805"]["C0230839"]
        self.assertTrue("SEMMED Chemical API" in get_apis(edges))
