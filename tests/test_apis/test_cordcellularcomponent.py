...
class TestSingleHopQuery(unittest.TestCase):
    ...
    def test_bp2chemicalsubstance(self):
        ...
        seqd = SingleEdgeQueryDispatcher(output_cls='ChemicalSubstance',
                                         ...
                                         values='GO:0000139')
        seqd.query()
        self.assertTrue('ACYL-COA' in seqd.G)
        edges = seqd.G['GO:GO:0000139']['ACYL-COA']
        self.assertTrue('CORD Cellular Component API' in get_apis(edges))
    ...
    def test_bp2bp(self):
        ...
        seqd = SingleEdgeQueryDispatcher(output_cls='BiologicalProcess',
                                         ...
                                         values='GO:0000139')
        seqd.query()
        self.assertTrue("catabolic process".upper() in seqd.G)
        edges = seqd.G['GO:GO:0000139']["catabolic process".upper()]
        self.assertTrue('CORD Cellular Component API' in get_apis(edges))
    ...
    def test_bp2cc(self):
        ...
        seqd = SingleEdgeQueryDispatcher(output_cls='CellularComponent',
                                         ...
                                         values='GO:0000139')
        seqd.query()
        self.assertTrue('LYSOSOME' in seqd.G)
        edges = seqd.G['GO:GO:0000139']['LYSOSOME']
        self.assertTrue('CORD Cellular Component API' in get_apis(edges))
